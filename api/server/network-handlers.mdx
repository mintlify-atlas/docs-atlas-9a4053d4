...
<ParamField path="moveCount" type="uint32">
  Number of moves (4 bytes)
</ParamField>

For each move:

<ParamField path="fromX" type="uint32">
  Source X coordinate (4 bytes)
</ParamField>

<ParamField path="fromY" type="uint32">
  Source Y coordinate (4 bytes)
</ParamField>

<ParamField path="toX" type="uint32">
  Destination X coordinate (4 bytes)
</ParamField>

<ParamField path="toY" type="uint32">
